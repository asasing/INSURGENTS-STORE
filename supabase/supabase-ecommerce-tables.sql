-- ====================================
-- E-COMMERCE TABLES FOR INSURGENTS STORE
-- Only creates new tables needed for the store
-- Uses existing 'profiles' table for admin authentication
-- ====================================
...
-- Insert sample sale
INSERT INTO sales (name, end_date, is_active, message)
SELECT 'Summer Sale 2026', '2026-02-15 23:59:59+00', true, 'Limited Time Sale - Up to 50% Off!'
WHERE NOT EXISTS (SELECT 1 FROM sales WHERE name = 'Summer Sale 2026');
